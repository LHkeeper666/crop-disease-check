...
const hoveredDisease = ref<string | null>(null)
</script>
        ...
        >
          <GlassCard :hoverable="true" class="group overflow-hidden !p-0 relative">
            <div class="aspect-square overflow-hidden bg-slate-900/50 relative">
              ...
              <div
                class="absolute inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer"
                @mouseenter="hoveredDisease = entry.file"
